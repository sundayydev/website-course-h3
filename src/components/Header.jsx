...
const Header = () => {
  ...
  const handleSearch = async () => {
    if (!searchQuery.trim()) {
      ...
      setIsSearchDropdownOpen(false); // Ẩn dropdown khi xóa hết
      return;
    }
    ...
    try {
      ...
      setSearchResults({ courses: [], posts: [] });
      setIsSearchDropdownOpen(true); // Vẫn hiển thị để thông báo lỗi
    } finally {
                        ...
                        <>
                          <div className="flex items-center gap-3 p-3">
                            <Avatar className="w-10 h-10">
                              <AvatarImage src={user?.avatarUrl || LogoH3} alt="User Avatar" />
