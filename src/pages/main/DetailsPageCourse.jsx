  ...
  const sections = [
      ...
      lessons: [
        {
          ...
          duration: '11:35',
          youtubeId: 't09bVi0LvSg',
          description: 'Buy tickets modal Javascript logic',
          updateDate: 'Cập nhật tháng 9 năm 2022',
          notes:
            'Nếu các bạn thấy phần bài tập trong bài học này là Javascript thì là đúng của hệ thống nhé. Để xử lý trong thời gian tới, các bạn vui lòng quá qua bài tập này. Cảm ơn các bạn 🙂🙂',
        },
        {
          id: 2,
          title: 'Domain là gì? Tên miền là gì?',
          duration: '10:34',
          youtubeId: 'rd7HVevuIwU',
          locked: false,
    ...
    },
    {
      ...
      lessons: [
        {
          id: 4,
          title: 'Giới thiệu môi trường IT',
          duration: '46:14',
          youtubeId: 'mPZkdNFkNps',
          description: 'Tổng quan về môi trường làm việc IT',
          updateDate: 'Cập nhật tháng 12 năm 2022',
          notes:
            'Bài học giới thiệu tổng quan về ngành IT, môi trường làm việc và các vị trí công việc phổ biến.',
        },
      ],
    },
  ];
    ...
    <div className="flex flex-col h-screen overflow-hidden bg-gray-50">
      ...
      <div className="bg-gray-800 text-white flex items-center justify-between p-4 h-[50px] mt-16">
        <div className="flex items-center">
          ...
          />
          <div className="bg-pink-500 rounded-full w-8 h-8 flex items-center justify-center font-bold">
            H3
          </div>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="flex items-center justify-between mb-2">
                <h2 className="text-2xl font-bold">
                  {currentLesson.description || currentLesson.title}
                </h2>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg w-full max-w-lg">
            ...
            <div className="flex justify-end space-x-2">
              ...
              <button className="px-4 py-2 bg-blue-500 text-white rounded-md" onClick={saveNote}>
                TẠO GHI CHÚ
              </button>
            </div>
          </div>
                      ...
                      <div key={note.id} className="border rounded-lg p-4">
                        <div className="flex justify-between mb-2">
                          <h3 className="font-medium">
                            {lesson ? lesson.title : 'Bài học không xác định'}
                          </h3>
