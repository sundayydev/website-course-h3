...
const PostDetails = () => {
  ...
  return (
    <div className="w-full bg-gray-100">
      <div className="w-full max-w-4xl mx-auto flex flex-col py-6 px-4 bg-gray-100 dark:bg-gray-900 mt-14">
        {/* Tiêu đề bài viết */}
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100 mt-10">
          {post.title}
        </h1>
