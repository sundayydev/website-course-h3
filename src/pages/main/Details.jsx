    ...
    <div className="max-w-7xl mx-auto p-4 bg-gray-50 grid grid-cols-1 lg:grid-cols-3 gap-8 mt-16">
      <div className="lg:col-span-2">
        ...
        <p className="text-gray-600 text-sm mt-2">
          Hiểu sâu hơn về cách Javascript hoạt động, tìm hiểu về IIFE, closure, reference types,
                ...
                <div className="bg-white p-3 border-x border-b rounded-b-2xl w-full">
                  <ul className="space-y-1 pl-4">
                    {subLessons.map((lesson, idx) => (
                      <li
                        key={idx}
                        className="flex items-center justify-between text-gray-600 text-sm py-1"
                      >
      ...
      <div className="flex flex-col items-center">
        ...
        <div
          ...
          style={{
            backgroundImage:
              'url(https://hinhneniphone.net/wp-content/uploads/2024/12/anh-gai-xinh-cute.png)',
        ...
        <Button
          className="mt-5 w-64 bg-pink-600 text-white rounded-2xl shadow-lg hover:bg-gray-600"
