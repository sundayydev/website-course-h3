...
const CourseCard = ({
  ...
  return (
    <div
      className={`rounded-2xl shadow-lg overflow-hidden ${bgColor} text-white w-full md:w-1/3 lg:w-[275px] transform transition-transform duration-300 hover:scale-105 flex flex-col cursor-pointer`}
      onClick={handleClick}
    >
    ...
    >
      ...
      <div className="bg-white text-black p-4">
        ...
        <div className="flex justify-between font-semibold items-center text-sm text-gray-500">
          ...
          <span className="flex items-center gap-2">
            <MdOutlinePlayCircleFilled /> {lessons}
          </span>
          <span className="flex items-center gap-2">
            <MdOutlineAccessTimeFilled /> {duration}
          </span>
        </div>
      </div>
    </div>
...
const PostCard = ({ title, author, readTime, image }) => {
  ...
  return (
    <div
      className="rounded-2xl shadow-lg overflow-hidden w-full md:w-1/3 lg:w-1/4 transform transition-transform duration-300 hover:scale-105 flex flex-col cursor-pointer"
      onClick={handleClick}
    >
...
const CourseList = () => {
  ...
  return (
    <div className="p-4">
      ...
      <div className="text-left mt-8 text-gray-600">432.776+ người khác đã học</div>
      <div className="flex justify-between items-center mb-8">
