...
const Comment = () => {
  ...
  // Fetch comments data (with mock data fallback)
  useEffect(() => {
    fetchComments();
  }, []);
  ...
  const fetchComments = async () => {
    try {
      ...
      setComments(mockData); // Sử dụng mock data tạm thời
    } finally {
      setLoading(false);
    }
  };
          ...
          <CardContent>
            <div className="rounded-md border">
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead className="text-pink-500">ID Người dùng</TableHead>
                    <TableHead className="text-pink-500">ID Bài viết</TableHead>
