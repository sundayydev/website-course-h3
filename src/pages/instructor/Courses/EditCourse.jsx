...
import { getCourseById, updateCourse, uploadImage } from '@/api/courseApi';
...
export default function EditCourse() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (course.urlImage) {
          setPreviewUrl(course.urlImage); // Set initial image preview
        }
      } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigate to course details page after successful update
  ...
  const handleRemoveImage = () => {
    setImageFile(null);
    setPreviewUrl(null);
    setCourseData((prev) => ({ ...prev, urlImage: '' }));
  };
    ...
    <div className="container mx-auto py-8 px-4 md:px-6 h-max-screen overflow-scroll">
      <div className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-3xl font-bold">Chỉnh sửa khóa học</h2>
        </div>
      </div>
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Chỉnh sửa chi tiết khóa học</CardDescription>
            </CardHeader>
            <CardContent>
